                    ...
                    <div class="well">
                        <div class="inline-block well_blanc"><h2><?php echo $article['Titre']; ?></h2></br>
                                  ...
                                  <div class="well detail_detail_article pull-right">
                                      <p>Prix de la livraison : Gratuit</br></br> Stock : <?php echo $stock; ?></br> </br> </br> Label : <?php echo $article['Editeur']; ?></br> </br> Date de sortie : <?php echo $article['Date_Edition']; ?></p>
